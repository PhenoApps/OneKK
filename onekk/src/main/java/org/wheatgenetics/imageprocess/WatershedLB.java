...
public class WatershedLB {
    ...
    public static class WatershedParams {
         ...
         * {@link WatershedLB.WatershedParams#WatershedParams(int, int, int, double, double)}.
         * </p>
         *
        ...
        public double getSizeLowerBoundRatio() {
            return sizeLowerBoundRatio;
        }

        public double getNewSeedDistRatio() {
            return newSeedDistRatio;
        }
     ...
     * <p>
     * This is a convenience for calling
     * {@link WatershedLB#WatershedLB(WatershedParams)}.
     * </p>
     */
